import 'package:bmi_calculator_app/screens/bmi_result_page.dart';
import 'package:bmi_calculator_app/widgets/custom_button.dart';
import 'package:bmi_calculator_app/sections/gender_section.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          CustomButton(buttonName: 'CALCULATE', page: BmiResultPage()),
        ],
      ),
    );
  }
